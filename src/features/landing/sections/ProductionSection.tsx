            ...
            <div className="relative z-10 w-full max-w-7xl mx-auto px-8 lg:pl-32">
                    ...
                    >
                        <div className="absolute inset-0 border border-white/10 p-2">
                            ...
                            <div className="w-full h-full flex flex-col gap-2 relative overflow-hidden">
                                <div className="w-full h-[calc(50%-4px)] relative flex items-center justify-center p-2 bg-[#101828]">
                                    <img
                                        src={printer1}
                                ...
                                <div className="w-full h-[calc(50%-4px)] relative flex items-center justify-center p-4 bg-[#101828]">
                                    <img
                                        src={printer2}
                ...
                <div className="space-y-12 relative">
                    <div className="flex items-center gap-4">
                        ...
                        <h3 className="text-2xl font-bold font-rajdhani uppercase tracking-[0.2em] text-white">
